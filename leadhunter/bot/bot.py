...
def create_dispatcher(
    ...
    # «🔍 Проверить сейчас» показывает лиды за то же окно свежести, что и
    # пайплайн: иначе экран заполняют заказы, которых на бирже давно нет.
    dp["max_lead_age_hours"] = settings.max_lead_age_hours
